...
export interface RuntimeEnv { DB: D1Database; DOCUMENTS: R2Bucket; BETTER_AUTH_SECRET?: string; BETTER_AUTH_URL?: string; GOOGLE_CLIENT_ID?: string; GOOGLE_CLIENT_SECRET?: string; OPENROUTER_API_KEY?: string; OPENROUTER_MODEL?: string; AI_MONTHLY_REQUEST_LIMIT?: string; AI_PUBLIC_ENABLED?: string; EMAIL?: SendEmail; EMAIL_FROM?: string; }
