          ...
          {tab === 'overview' && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-x-4 gap-y-3 sm:grid-cols-3 lg:grid-cols-4">
                ...
                <Fact label={user.characterScope === 'account' ? t('Karakter AI (jatah sekali pakai)', 'AI characters (one-time allowance)') : t('Karakter AI periode ini', 'AI characters this period')}>{numberFormat(user.charactersUsed, locale)} / {user.unlimited ? '∞' : numberFormat(user.characterLimit, locale)}</Fact>
