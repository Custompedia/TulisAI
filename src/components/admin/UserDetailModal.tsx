...
export function TierBadge({ tier, t }: { tier: Tier; t: (id: string, en: string) => string }) {
  const tone = { free: 'bg-paper-deep text-ink-600', plus: 'bg-mode-blue-light text-mode-blue-ink', pro: 'bg-mode-gold-light text-mode-gold-ink', team: 'bg-mode-slate-light text-mode-slate-ink' }[tier];
