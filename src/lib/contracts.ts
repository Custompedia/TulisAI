...
const EditorNodeSchema: z.ZodType<EditorNode> = z.lazy(() => z.object({
  type: z.enum(["paragraph", "heading", "text", "bulletList", "orderedList", "listItem", "taskList", "taskItem", "hardBreak", "blockquote", "horizontalRule", "pageBreak", "table", "tableRow", "tableHeader", "tableCell"]),
